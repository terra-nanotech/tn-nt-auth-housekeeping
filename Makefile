# Makefile for TN-NT Auth Housekeeping
...
# Variables
appname = tnnt-housekeeping
appname_verbose = TN-NT Auth Housekeeping
package = tnnt_housekeeping
...
git_repository = https://github.com/terra-nanotech/tn-nt-auth-housekeeping
